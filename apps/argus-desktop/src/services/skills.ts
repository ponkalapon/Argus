...
export const PRESET_SKILLS: PresetSkill[] = [
  {
    ...
    pattern: 'Проведи глубокй рефакторинг данного кода: сделай его чистым, производительным, безопасным, обработай краевые случаи и добавь понятные комментарии к сложной логике.',
